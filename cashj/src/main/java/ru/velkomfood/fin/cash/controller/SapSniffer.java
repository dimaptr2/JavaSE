...
import ru.velkomfood.fin.cash.model.DeliveryHead;
import ru.velkomfood.fin.cash.model.DeliveryItem;
        ...
        do {
            ...
            if (posText.equals("")) {
                ...
                if (elems[0].charAt(0) == '8') {
                    ...
                    cj.setDocumentDate(itab.getString("DOCUMENT_DATE"));
                    cj.setPostingDate(itab.getString("POSTING_DATE"));
